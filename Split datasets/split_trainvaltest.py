...
"""Masks = '/home/nivii/Desktop/Data/wicv/Masks'
Annotations = '/home/nivii/Desktop/Data/wicv/Annotations'

out_masks_train = '/home/nivii/Desktop/Data/wicv/Image_Data/train/Masks'
out_annotation_train = '/home/nivii/Desktop/Data/wicv/Image_Data/train/Annotations'

masks_test = '/home/nivii/Desktop/Data/wicv/Image_Data/train/Masks'
annotation_test = '/home/nivii/Desktop/Data/wicv/Image_Data/test/Annotations'"""
...
if __name__ == '__main__':
    ...
    for split in ['train', 'test']: #'val',
        ...
        for filename in tqdm(filenames[split]):
            ...
            # Use bilinear interpolation instead of the default "nearest neighbor" method
            #image = image.resize((size, size), Image.BILINEAR)
            image.save(os.path.join(args.output_dir, filename.split('/')[-1]))

            """mask = Image.open(os.path.join(Masks, name_of_file + '_masks.jpg'))
                                                image.save(os.path.join(out_masks_train, name_of_file  + '_masks.jpg'))
                                    
                                                shutil.copy(os.path.join(Annotations, name_of_file  + '.xml'), os.path.join(out_annotation_train, name_of_file  + '.xml'))"""
